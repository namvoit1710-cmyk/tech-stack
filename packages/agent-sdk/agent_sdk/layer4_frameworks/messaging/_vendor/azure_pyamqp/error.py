...
from .constants import FIELD, SECURE_PORT
...
AMQPError = namedtuple(
    "AMQPError", ["condition", "description", "info"], defaults=[None, None]
)
...
class AMQPException(Exception):
    ...
    def __init__(self, condition: bytes, **kwargs: Any):
        self.condition: Union[bytes, ErrorCondition] = (
            condition or ErrorCondition.UnknownError
        )
