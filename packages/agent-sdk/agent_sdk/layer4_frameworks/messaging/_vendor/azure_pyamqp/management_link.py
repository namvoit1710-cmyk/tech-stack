...
PendingManagementOperation = namedtuple(
...
class ManagementLink(object):  # pylint:disable=too-many-instance-attributes
    ...
    def __init__(self, session, endpoint, **kwargs):
        ...
        self._status_description_field = kwargs.get(
    ...
    def _on_send_complete(
        ...
        if (
            reason == LinkDeliverySettleReason.DISPOSITION_RECEIVED
            and SEND_DISPOSITION_REJECT in state
        ):
