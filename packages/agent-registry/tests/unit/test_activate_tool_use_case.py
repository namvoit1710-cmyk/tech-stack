"""Unit tests for ActivateToolUseCase."""
...
class TestActivateToolUseCase:
    """Test ActivateToolUseCase."""
    ...
    def use_case(self, mock_repository):
        return ActivateToolUseCase(repository=mock_repository)

    def test_activate_tool_success(self, use_case, mock_repository, sample_tool_data):
    ...
    def test_activate_already_active_tool(self, use_case, mock_repository, sample_tool_data):
